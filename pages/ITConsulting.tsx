...
const ITConsulting = () => {
    ...
    return (
        <div className="min-h-screen bg-[#111]">
            ...
            <main>
                <section className="py-20 bg-gradient-to-br from-blue-50 via-white to-blue-200">
                    <div className="max-w-5xl mx-auto px-4">
                        ...
                        <div className="flex flex-wrap justify-center gap-6 mb-16">
                            <div className="flex flex-col items-center">
                                <img src="https://placehold.co/64x64/dbeafe/1e3a8a?text=PS" alt="Consultant Priya Sharma" className="h-16 w-16 rounded-full border-2 border-blue-300 mb-2" />
                                <span className="font-semibold text-blue-800">Priya Sharma</span>
                                <span className="text-xs text-slate-500">Lead Consultant</span>
                            </div>
                            <div className="flex flex-col items-center">
                                <img src="https://placehold.co/64x64/dbeafe/1e3a8a?text=RM" alt="Consultant Rahul Mehta" className="h-16 w-16 rounded-full border-2 border-blue-300 mb-2" />
                                <span className="font-semibold text-blue-800">Rahul Mehta</span>
                                <span className="text-xs text-slate-500">Cloud Architect</span>
                            </div>
                            <div className="flex flex-col items-center">
                                <img src="https://placehold.co/64x64/dbeafe/1e3a8a?text=AK" alt="Consultant Aisha Khan" className="h-16 w-16 rounded-full border-2 border-blue-300 mb-2" />
                        ...
                        <div className="mb-16">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="bg-white/90 rounded-xl p-6 shadow border border-blue-100 flex items-center gap-4">
                                    <img src="https://placehold.co/48x48/e0e7ff/3730a3?text=BG" alt="BizGrowth logo" className="h-12 w-12 rounded-full" />
                                    <div>
                                ...
                                <div className="bg-white/90 rounded-xl p-6 shadow border border-blue-100 flex items-center gap-4">
                                    <img src="https://placehold.co/48x48/e0e7ff/3730a3?text=CE" alt="CloudEdge logo" className="h-12 w-12 rounded-full" />
                                    <div>
