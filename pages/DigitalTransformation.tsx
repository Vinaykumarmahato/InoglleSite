...
const DigitalTransformation = () => {
    ...
    return (
        <div className="min-h-screen bg-[#111]">
            ...
            <main>
                <section className="py-20 bg-gradient-to-br from-blue-200 via-white to-blue-300">
                        ...
                        <div className="mb-16">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="bg-white/90 rounded-xl p-6 shadow border border-blue-100 flex items-center gap-4">
                                    <img src="https://placehold.co/48x48/e0e7ff/3730a3?text=NG" alt="NextGen logo" className="h-12 w-12 rounded-full" />
                                    <div>
                                ...
                                <div className="bg-white/90 rounded-xl p-6 shadow border border-blue-100 flex items-center gap-4">
                                    <img src="https://placehold.co/48x48/e0e7ff/3730a3?text=AP" alt="AutoPro logo" className="h-12 w-12 rounded-full" />
                                    <div>
