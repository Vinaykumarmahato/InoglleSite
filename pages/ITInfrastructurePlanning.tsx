                        ...
                        <div className="mb-16">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="bg-white/90 rounded-xl p-6 shadow border border-blue-100 flex items-center gap-4">
                                    <img src="https://placehold.co/48x48/e0e7ff/3730a3?text=IM" alt="InfraMax logo" className="h-12 w-12 rounded-full" />
                                    <div>
                                ...
                                <div className="bg-white/90 rounded-xl p-6 shadow border border-blue-100 flex items-center gap-4">
                                    <img src="https://placehold.co/48x48/e0e7ff/3730a3?text=SI" alt="SecureIT logo" className="h-12 w-12 rounded-full" />
                                    <div>
