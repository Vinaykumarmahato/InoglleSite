...
export default function Home() {
  // Remove Vanta globe and extra sections for 100% match
    ...
    <div className="min-h-screen bg-[#111] text-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <section className="bg-gradient-to-br from-[#0a0f1c] via-[#111] to-[#1a2a3c] rounded-2xl border border-blue-900 shadow-xl p-8 md:p-16 flex flex-col items-center text-center relative mb-12">
          ...
          {/* Partner logos auto-scrolling row */}
      ...
      {/* --- Begin: Added Section from Screenshot --- */}
      <div className="bg-[#101522] text-white py-20 px-4">
        ...
        <section className="max-w-4xl mx-auto text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 justify-center mt-8">
            <div className="bg-[#181f2a] rounded-xl p-6 border border-slate-700 shadow flex flex-col items-start">
              ...
              <a href="#" className="text-blue-400 font-medium mt-2">Start Planning &rarr;</a>
            </div>
            <div className="bg-[#181f2a] rounded-xl p-6 border border-slate-700 shadow flex flex-col items-start">
              ...
              <a href="#" className="text-blue-400 font-medium mt-2">Begin Development &rarr;</a>
            </div>
          </div>
        </section>
        <section className="max-w-4xl mx-auto text-center mb-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 justify-center max-w-3xl mx-auto mt-8">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-slate-400 mt-2">Client Satisfaction Rate.</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-3xl font-bold text-white">11-50</span>
              <span className="text-slate-400 mt-2">Dedicated Team Members.</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-3xl font-bold text-white">2,023</span>
      ...
      {/* --- End: Added Section from Screenshot --- */}
      </main>
    </div>
  );
}